	...
	public void onValueChange(ValueChangeEvent<String> event) {
		...
		if (token != null) {
			...
			if (token.equals(PresenterName.addPage.name()) || token.equals(PresenterName.editPage.name())
					...
					|| token.equals(PresenterName.user.name()) || token.equals(PresenterName.addUser.name()) || token.equals(PresenterName.editUser.name())
					|| token.equals(PresenterName.addList.name()) || token.equals(PresenterName.editList.name())
					|| token.equals(PresenterName.addText.name()) || token.equals(PresenterName.editText.name())
					|| token.equals(PresenterName.addConnection.name()) || token.equals(PresenterName.editConnection.name())
					...
					|| token.equals(PresenterName.addForumPost.name()) || token.equals(PresenterName.editForumPost.name())
					|| token.equals(PresenterName.addNews.name()) || token.equals(PresenterName.editNews.name())
					|| token.equals(PresenterName.addSerial.name()) || token.equals(PresenterName.editSerial.name())
					|| token.equals(PresenterName.addMessage.name())
					|| token.equals(PresenterName.editLabels.name())) {
				((PagePresenter)LocalStorage.getInstance().getPresenter(PresenterName.page.name())).displayContextPanel(token);
			} else {
