...
public class SecurityUtils {
	...
	public static List<String> getHashWithSalt(String textToHash) throws NoSuchAlgorithmException, UnsupportedEncodingException {
	...
	public static String getHashWithoutSalt(String textToHash) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        // Digest computation
	...
	/**
	    ...
	    * @param textToHash String The text to encrypt
	    * @param salt byte[] The salt
	    * @return byte[] The digested text
	    * @throws NoSuchAlgorithmException If the algorithm doesn't exist
	    * @throws UnsupportedEncodingException 
	    */
	   private static byte[] getHash(int iterationNb, String textToHash, byte[] salt) throws NoSuchAlgorithmException, UnsupportedEncodingException {
