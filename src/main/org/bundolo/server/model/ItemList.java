...
public class ItemList implements java.io.Serializable {
	...
	public ItemList(Long itemListId, String authorUsername, ItemListStatusType itemListStatus, ItemListKindType kind, Date creationDate, String query, Long descriptionContentId) {
		super();
