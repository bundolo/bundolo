...
public class Utils {
	...
	if (parentContentKind != null) {
		...
		break;
	    // serials have description instead of text, episodes didn't have descriptions in the
	    // old version
	    // case episode_group:
	...
	if ((hasText(presenterName)) && (!presenterName.equalsIgnoreCase(History.getToken()))) {
