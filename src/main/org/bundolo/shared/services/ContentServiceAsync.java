...
//	void saveContent(Long contentId, Long authorUserId, Long parentPageId, Long parentContentId, ContentKindType kind, String text, String locale, Date creationDate, ContentStatusType contentStatus, AsyncCallback<Void> callback);
//
//	void saveOrUpdateContent(Long contentId, Long authorUserId, Long parentPageId, Long parentContentId, ContentKindType kind, String text, String locale, Date creationDate, ContentStatusType contentStatus, AsyncCallback<Void> callback);
//
//	void updateContent(Long contentId, Long authorUserId, Long parentPageId, Long parentContentId, ContentKindType kind, String text, String locale, Date creationDate, ContentStatusType contentStatus, AsyncCallback<Void> callback);
	
	void saveContent(ContentDTO contentDTO, AsyncCallback<Long> callback);

	//void saveOrUpdateContent(ContentDTO contentDTO, AsyncCallback<Void> callback);
